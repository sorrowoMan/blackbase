...
RUNTIME_CONTEXT_SCHEMA = ContextSchema(
    ...
    fields=[
        ...
        ContextField(
            "best_candidate_ref",
            CATEGORY_OUTPUT,
            "best candidate snapshot reference when it exceeds the inline limit (optional)",
        ),
        ...
        ContextField(
            "best_x",
            CATEGORY_RUNTIME,
            "bounded inline best candidate (optional; large values use best_candidate_ref)",
        ),
        ContextField("best_objective", CATEGORY_RUNTIME, "current best scalar objective (optional)"),
        ContextField(
            "runtime_projection_audit",
            CATEGORY_RUNTIME,
            "bounded Adapter runtime projection audit without omitted field values (optional)",
        ),
        ...
        ContextField(
            "population",
            CATEGORY_CACHE,
            "transient in-process population; persistent ContextStore uses population_ref",
            replayable=False,
        ),
        ContextField(
            "objectives",
            CATEGORY_CACHE,
            "transient in-process objectives; persistent ContextStore uses objectives_ref",
            replayable=False,
        ),
        ContextField(
            "constraint_violations",
            CATEGORY_CACHE,
            "transient in-process violations; persistent ContextStore uses constraint_violations_ref",
            replayable=False,
        ),
        ContextField(
            "pareto_solutions",
            CATEGORY_CACHE,
            "transient in-process Pareto solutions; persistent ContextStore uses pareto_solutions_ref",
            replayable=False,
        ),
        ContextField(
            "pareto_objectives",
            CATEGORY_CACHE,
            "transient in-process Pareto objectives; persistent ContextStore uses pareto_objectives_ref",
            replayable=False,
        ),
        ...
        ContextField("history", CATEGORY_EVENT, "transient runtime history; persistent ContextStore uses history_ref", replayable=False),
